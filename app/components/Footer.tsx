      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-[#778da9]">Jason Sacerio</h3>
          ...
          {/* Social stuff */}
          <div className="space-y-4">
            <h4 className="text-lg font-semibold text-[#778da9]">Connect</h4>
        ...
        {/* Copyright */}
        <div className="border-t border-[#e0e1dd]/20 mt-8 pt-8 text-center">
          <p className="text-[#e0e1dd]/60">
